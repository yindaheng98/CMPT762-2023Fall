...
for epoch in range(num_epochs):
  ...
  torch.save(model.state_dict(), '{}/output/{}_large_segmentation_model.pth'.format(BASE_DIR, epoch))
  print("Next learning rate:", scheduler.get_last_lr())

'''
# Saving the final model
'''
torch.save(model.state_dict(), '{}/output/final_large_segmentation_model.pth'.format(BASE_DIR))
